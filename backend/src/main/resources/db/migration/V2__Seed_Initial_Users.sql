...
INSERT INTO module_items (module_id, title, type, file_type, file_size, url, sort_order, created_at, is_assignment, due_date, is_visible, max_grade, submission_type, description)
VALUES
    (2, 'Data Structures VisuAlgo', 'resource', 'link', 'URL', 'https://visualgo.net', 1, '2026-10-26 09:15:00', FALSE, NULL, TRUE, NULL, NULL, NULL),
    (2, 'Lab 1 · Arrays Implementation', 'assignment', 'zip', '5.8 MB', '/files/lab1.zip', 2, NOW(), TRUE, DATE_ADD(CURRENT_DATE, INTERVAL 2 DAY), TRUE, 100, 'File', 'Please upload your Java project archived as ZIP.'),
    (2, 'Project_Starter_Code.zip', 'resource', 'zip', '14.2 MB', '/files/project.zip', 3, '2026-11-01 16:00:00', FALSE, NULL, TRUE, NULL, NULL, NULL),
    (2, 'Hidden Instructor Notes.docx', 'resource', 'docx', '1.2 MB', '/files/notes.docx', 4, NOW(), FALSE, NULL, FALSE, NULL, NULL, NULL);
...
INSERT INTO categories (id, name, parent_id, sort_order) VALUES (4, 'Arrays & Lists', 3, 0);
INSERT INTO categories (id, name, parent_id, sort_order) VALUES (5, 'Trees & Graphs', 3, 1);
...
INSERT INTO questions (text, type, difficulty, usage_count, category_id)
VALUES ('Describe the main principles of Object Oriented Programming in your own words.', 'FREE_TEXT', 'HARD', 0, 2);
INSERT INTO question_tags (question_id, tag_id) VALUES (LAST_INSERT_ID(), 3);
